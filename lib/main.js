const { CompositeDisposable } = require('soldat')
...
module.exports = {
  activate () {
    ...
    if (availableVersion === soldat.getVersion()) {
  ...
  createModel () {
    ...
    this.model = new About({
      uri: AboutURI,
      currentVersion: soldat.getVersion(),
  ...
  isUpdateAvailable () {
    let availableVersion = window.localStorage.getItem(AvailableUpdateVersion)
    return availableVersion && availableVersion !== soldat.getVersion()
  },
